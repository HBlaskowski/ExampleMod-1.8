...
public class ModModels
{
    ...
    public static void init()
    {
        if (Settings.General.enableModBlocks)
        {
            ...
            registerItemBlockModel(ModBlocks.nether_sapphire_ore, 0, Names.Blocks.NETHER_SAPPHIRE_ORE);
            registerItemBlockModel(ModBlocks.end_sapphire_ore, 0, Names.Blocks.END_SAPPHIRE_ORE);

            registerItemBlockModel(ModBlocks.ruby_ore, 0, Names.Blocks.RUBY_ORE);
            registerItemBlockModel(ModBlocks.nether_ruby_ore, 0, Names.Blocks.NETHER_RUBY_ORE);
            registerItemBlockModel(ModBlocks.end_ruby_ore, 0, Names.Blocks.END_RUBY_ORE);
        }
